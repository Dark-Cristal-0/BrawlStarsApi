...
const {EventMode} = require("./primitive/EventMode");
...
module.exports = {
  ...
  Brawler,BrawlerList,
  BrawlerStat,BrawlerStatList,
  ClientError,
  Club,
  ClubMember,ClubMemberList,
  ClubRanking,ClubRankingList,
  GearStat,GearStatList,
  Player,
  PlayerClub,
  PlayerIcon,
  PlayerRankingClub,
  PlayerRanking,
  StarPower,StarPowerList,
